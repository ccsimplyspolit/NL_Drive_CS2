...
через MmCopyVirtualMemory). На КАЖДЫЙ кил делает две вещи:
  ...
  1. Жмёт F20 ровно 2.5 секунды (статичный hold). Кили в течение этого
     окна игнорируются - это и есть cooldown.
  2. Один раз нажимает случайную клавишу Numpad 0-9. Никогда не нажимает
     ту же, что в прошлый раз (равномерно из 9 оставшихся).
